...
GRANT EXECUTE ON FUNCTION public.barber_has_public_access (uuid) TO anon, authenticated;
...
-- Sem SELECT público em subscriptions (Stripe IDs); use barber_has_public_access() nas policies.
